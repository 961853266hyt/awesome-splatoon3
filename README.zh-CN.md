# Awesome Splatoon3 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) ![GitHub stars](https://img.shields.io/github/stars/961853266hyt/awesome-splatoon3?style=social) ![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)
...
斯普拉遁3 归任天堂所有。本项目是一个非官方的社区维护资源列表。
...
- [Splatoon 3 Calendars](https://shiky.me/splatoon3) - 斯普拉遁 3 真格、打工和活动比赛的日历订阅生成工具。
...
- [memesquid](https://diudiu-wl.github.io/download-memesquid/) - 一个陪你看视频的可爱桌宠。
- [Mollusk Voice Changer](https://itohyakkei.booth.pm/items/8308198) - 免费的实时章鱼和鱿鱼变声器。
- [little squid pet](https://diudiu-wl.github.io/downloadsquid/) - 一个可爱桌宠，支持识别输赢、连接直播弹幕和对话等功能。
...
欢迎各位章章鱿鱿提交贡献。提交 pull request 前，请先阅读[贡献指南](CONTRIBUTING.zh-CN.md)。
